function calcular() {
    ...
    if (isNaN(a1)) {
        if (isNaN(raz) || isNaN(posterm) || isNaN(respa)) {
            ...
            document.getElementById('res').innerHTML =  '<br> an = a1 + r.(n-1)  ' + '<br>' +  '<br> a1 = an - r.(n-1)  ' + '<br><br>';
    ...
    //Calcular n
        ...
        if (isNaN(a1) || isNaN(raz) || isNaN(respa)) {
            ...
            document.getElementById('res2').innerHTML =  respa + ' = '  +  a1   + ' + ' + raz+'n'+'+' +( (-1 )* raz )+ '<br><br>';
            document.getElementById('res3').innerHTML =  respa + ' = '  + (a1+((-1)*raz)) +'+' + raz+'n'  +'<br><br>';
            document.getElementById('res4').innerHTML =  -(a1+((-1)*raz)) + respa +' = ' + raz+'n' + '<br><br>';
            document.getElementById('res5').innerHTML =(-(a1+((-1)*raz)) + respa) +'/'+raz+' = ' +'n'+ '<br><br>';
